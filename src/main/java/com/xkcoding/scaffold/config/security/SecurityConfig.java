...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) {
        // 忽略指定资源
        web.ignoring()
                .antMatchers(ScaffoldConst.AUTHENTICATION_LOGIN_PAGE, ScaffoldConst.DEFAULT_VALIDATE_CODE_URL_PREFIX + "/*");
    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.formLogin()
                .loginPage(ScaffoldConst.AUTHENTICATION_LOGIN_PAGE)
                .loginProcessingUrl(ScaffoldConst.DEFAULT_LOGIN_PROCESSING_URL_FORM)
